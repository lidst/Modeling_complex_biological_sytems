...
pdf("Stadnik_problem1.pdf", height=8, width=8)  # Use pdf() instead of png()
heatmap.2(edata,
...
```{r}
ggsave("Stadnik_problem2.pdf", ggplot(PC) + geom_point(aes(x=V3, y=V2, col=as.factor(strain))) +  labs(title = "PCA 2 vs PCA 3: Strain-Based Grouping")+ 
